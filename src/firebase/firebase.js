...
export { onAuthStateChanged,signInWithEmailAndPassword, getAuth, updateProfile, doc, auth, createUserWithEmailAndPassword, collection, setDoc, db, storage, ref, uploadBytesResumable, getDownloadURL,getDoc  }
